...
---
<details>
<summary>설계 문서 정리</summary>
<div markdown="1">

- [요구사항 명세서](./docs/requirements_docs/requiremetnsDocuments.md)
- [유스케이스 다이어그램](./docs/requirements_docs/useCase.md)
- [시퀀스 다이어그램](./docs/requirements_docs/sequenceDiagram.md)
- [클래스 다이어그램](./docs/requirements_docs/classDiagram.md)
- [ERD](./docs/requirements_docs/erd.md)
- [마일스톤](https://github.com/users/LK920/projects/2)
</div>
</details>
